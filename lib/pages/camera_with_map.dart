                      ...
                      style: OutlinedButton.styleFrom(
                        ...
                        shape: RoundedRectangleBorder(
                          ...
                          children: [
                             ...
                             SizedBox(width: 5),
                             Icon(Icons.photo_camera_outlined, size: 40, color: Colors.white54,)
                          ],
                        ),
                      ), 
                    ),  
                  ...
                  children: [
                    ...
                    style: OutlinedButton.styleFrom(
                      ...
                      elevation: 10,
                       ...
                       children: [
                        Icon(Icons.comment, size: 25, color: Colors.white54,),
                        SizedBox(width: 10),
                        Text("Absen Masuk",
                          style: TextStyle(
                            fontSize: 16,
                    ...
                    style: OutlinedButton.styleFrom(
                      ...
                      elevation: 10,
                       ...
                       children: [
                        ...
                        SizedBox(width: 10),
                        Icon(Icons.keyboard_return_outlined, size: 25, color: Colors.white54),
                       ],
                     ),
                      ), 
                       SizedBox(height: 20), 
